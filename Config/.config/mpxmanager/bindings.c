...
Binding customBindings[] = {
    ...
    {0, XF86XK_AudioLowerVolume, {spawn,  .arg = {.str = "pamixer -d 1"}} },
    {0, XF86XK_AudioRaiseVolume, {spawn,  .arg = {.str = "pamixer -i 1"}} },
    {0, XF86XK_AudioMute, {spawn,  .arg = {.str = "pamixer -t"}} },
    {ShiftMask, XF86XK_AudioLowerVolume, {spawn,  .arg = {.str = "pamixer --default-source -d 1"}} },
    {ShiftMask, XF86XK_AudioRaiseVolume, {spawn,  .arg = {.str = "pamixer --default-source -i 1"}} },
    {ShiftMask, XF86XK_AudioMute, {spawn,  .arg = {.str = "pamixer -t"}} },
    {0, XF86XK_AudioMicMute, {spawn,  .arg = {.str = "pamixer --default-source -t"}} },
